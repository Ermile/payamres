...
public class smsnew_jsonArray {
    ...
    public smsnew_jsonArray(String localid, String from, String text, String date, String smsid, String userdata, String brand, String model, String simcartSerial) {
